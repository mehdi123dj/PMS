...
def main():
    ...
    df_train.to_csv(args.data_path + '/train_lem.csv',sep=',', index=False)
    df_valid.to_csv(args.data_path + '/valid_lem.csv',sep=',', index=False)
    df_test.to_csv(args.data_path + '/test_lem.csv',sep=',', index=False)
